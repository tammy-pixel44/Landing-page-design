...
const faqs = [
  ["What exactly does Cardeify do?", "Cardeify is a decision layer for a multi-card wallet. Before a purchase, it compares the payment context against the cards in your wallet and identifies the strongest value for that moment."],
  ["Does Cardeify make the payment?", "Cardeify is the advisor, not the bank or payment processor. You stay in control of the actual payment flow."],
  ...
  ["Are the figures on this page live recommendations?", "No. The interactive figures in this standalone landing concept are deliberately labelled demo fixtures. Production recommendations should come from Cardeify's real wallet and reward engine."],
  ["What happens when reward rules change?", "The broader Cardeify product includes reward-value history and devaluation detection so the recommendation system can react when a previously strong card becomes less valuable."],
  ...
  return (
    <main>
      ...
      <nav className="nav-shell" aria-label="Primary navigation">
        ...
        <a className="nav-cta" href="#cta"><span>JOIN US</span><i>↗</i></a>
      </nav>
      ...
      <section className="hero-shell" id="top">
        <div className="hero-sticky">
          ...
          <div className="hero-copy">
            ...
            <h1 aria-label="Know which card to use before you pay.">
          ...
          <div className="hero-fan-cta hero-actions">
            ...
            <small>Exact ₹ recommendations · demo experience</small>
          </div>
      ...
      <section className="catalogue-rail" aria-label="Representative issuer context">
        ...
        <p>Representative issuer context for the concept — not a partnership claim. Production coverage should come from the live Cardeify catalogue.</p>
      </section>
      ...
      <section className="anatomy-stage" id="logic">
        <div className="anatomy-pin">
          <div className="anatomy-copy">
            ...
            <p>The useful number only appears after the purchase meets the wallet. Scroll through the variables Cardeify has to resolve before a recommendation deserves confidence.</p>
          ...
          <div className="anatomy-visual" aria-hidden="true">
            ...
            <div className="anatomy-output"><span>ONE ACTIONABLE OUTPUT</span><strong>₹62</strong><small>expected demo value · before payment</small></div>
          </div>
        </div>
      </section>
      ...
      <section className="lab-stage" id="lab">
        <div className="lab-heading" data-reveal>
          ...
          <div className="lab-heading__grid">
            ...
            <p>The recommendation should respond to the payment moment, not stay fixed because one card has the loudest headline rate.</p>
          </div>
        </div>
        <DecisionLab />
      </section>
      ...
      <section className="checkout-stage" id="checkout">
        <div className="checkout-copy" data-reveal>
          ...
          <p>Cardeify compresses wallet rules into one recommendation while the decision is still useful. Run the demo sequence to see the payment moment resolve.</p>
        ...
        <div className="qr-handoff" data-reveal>
          ...
          <div className="qr-device" aria-hidden="true">
            ...
            <div className="qr-viewfinder"><div className="fake-qr-grid" /><i className="qr-scanline" /></div>
            <div className="qr-sheet"><span>BEST DEMO CARD</span><div><strong>UPI Edge</strong><b>₹43</b></div><small>Continue in your payment app →</small></div>
          </div>
        </div>
      </section>
      ...
      <section className="trust-stage" id="trust">
        ...
        <div className="lifecycle-track">
          <article data-reveal><span>BEFORE PAYMENT</span><div className="lifecycle-number">₹62</div><h4>Pick the strongest card now.</h4><p>Resolve the payment moment while the choice can still change.</p></article>
          <article data-reveal><span>AFTER PAYMENT</span><div className="cashback-ledger" aria-hidden="true"><i /><i /><i /><b /></div><h4>Promised vs received.</h4><p>Track whether the expected cashback actually arrives instead of assuming it did.</p></article>
          <article data-reveal><span>OVER TIME</span><div className="nerf-signal" aria-hidden="true"><i /><i /><i /><i /><b /></div><h4>Catch the nerf before habit wins.</h4><p>Reward-value history and unclaimed-value signals keep an old favourite from quietly becoming expensive.</p></article>
        </div>
      </section>

      <section className="faq-stage" id="faq">
        <div className="faq-heading" data-reveal><div className="section-index section-index--dark">06 / QUESTIONS BEFORE TRUST</div><h2>Finance products should answer the uncomfortable questions.</h2></div>
      ...
      <section className="cta-stage" id="cta">
        <div className="cta-rings" aria-hidden="true"><i className="cta-ring cta-ring--a" /><i className="cta-ring cta-ring--b" /><div className="cta-card-silhouette" /></div>
        <div className="cta-copy" data-reveal>
          ...
          <p>Your wallet already contains the value. Cardeify&apos;s job is to surface it before the moment passes.</p>
